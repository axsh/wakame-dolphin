...
ruby_ver=${ruby_ver:-2.0.0-p353}
whereami="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
root_path="$( cd $whereami/../.. && pwd )"
ruby_install_dir=${ruby_install_dir:-$root_path/ruby}
tmp_dir=${tmp_dir:-/tmp}
...
dependencies=(make git gcc gcc-c++ zlib-devel openssl-devel mysql-devel sqlite-devel)
